...
//   const imageUrl = restaurant.image || PLACEHOLDER_IMAGE
//   const distanceText = restaurant.distance ? `${restaurant.distance.toFixed(1)}km away` : ''
//   const rating = restaurant.rating || "4.8"
//   const reviews = restaurant.reviews || "124"
//   const address = restaurant.address || `${restaurant.city}, Finland`
...
//             <Badge status={restaurant.halal_status || restaurant.status || restaurant.halalStatus} />
//           </div>
//         </div>
...
//             {cuisine} {distanceText && `• ${distanceText}`}
//           </p>
...
//               <div className="text-sm flex flex-col gap-2 font-medium">
//                 <div className="flex justify-between text-gray-600">
//                   <span>Mon - Thu</span>
//                   <span>11:00 - 21:00</span>
//                 </div>
//                 <div className="flex justify-between text-gray-900 bg-white/60 px-2 py-1 rounded">
//                   <span>Friday</span>
