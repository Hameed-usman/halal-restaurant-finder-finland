...
export function Sidebar() {
  ...
  if (selectedRestaurant) {
    return (
      <div className="w-1/2 h-full bg-white relative flex flex-col shrink-0 border-l border-gray-200 z-10 shadow-2xl">
        <button 
  ...
  return (
    <div className="w-1/2 h-full flex shrink-0 border-r border-gray-200">
      <NavPanel />
